...
export class BuildService {
    ...
    public async triggerBuild(projectId: string, initiator: BuildInitiator = 'command'): Promise<void> {
        ...
        try {
            ...
            this.plugin.clearLastBuildDiagnosticInfo(projectId);
            ...
            this.plugin.setLastBuildDiagnosticInfo(projectId, finalDiagnosticInfo);
    ...
    private async _ensureEsbuildInitialized(context: BuildContext): Promise<void> {
        if (this.esbuildService.isInitialized() && this.esbuildService.getEsbuildAPI()) return;
